...
export default function Starter() {
  ...
  ScrollParent(animRow, "anim1", 0, 300, 1200);
  return (
      ...
      <div className="relative container h-full flex justify-evenly items-center flex-col z-10 ">
        ...
        <div className="flex flex-col items-center gap-6 text-center thenShow">
          ...
          <div className="flex items-center gap-5 mt-5">
            <button className="w-[250px] h-[45px] text-main rounded-[12px] bg-white font-onBold tracking-wider transition-colors hover:bg-whiteHover">
              შეკვეთა
            </button>
            <button className="w-[250px] h-[45px] text-main rounded-[12px] bg-white font-onBold tracking-wider transition-colors hover:bg-whiteHover">
              ჩვენს შესახებ
        ...
        >
          <div className="anim1 cursor-pointer w-[350px] flex-col flex justify-between items-start h-[110px] rounded-[15px] bg-whiteCardBg backdrop-blur-whiteCard p-[15px] pb-[15px] shadow-[0_8px_0_rgba(103,103,103,0.05)] hovEffects transition-[transform_opacity] duration-[1s] after:bg-cyan">
          ...
          <div className="anim1 cursor-pointer w-[350px] flex-col flex justify-between items-start h-[110px] rounded-[15px] bg-whiteCardBg backdrop-blur-whiteCard p-[15px] pb-[15px] shadow-[0_8px_0_rgba(103,103,103,0.05)] hovEffects transition-[transform_opacity] duration-[1s] after:bg-red">
          ...
          <div className="anim1 cursor-pointer w-[350px] flex-col flex justify-between items-start h-[110px] rounded-[15px] bg-whiteCardBg backdrop-blur-whiteCard p-[15px] pb-[15px] shadow-[0_8px_0_rgba(103,103,103,0.05)] hovEffects transition-[transform_opacity] duration-[1s] after:bg-purple">
          ...
          <div className="anim1 cursor-pointer w-[350px] flex-col flex justify-between items-start h-[110px] rounded-[15px] bg-whiteCardBg backdrop-blur-whiteCard p-[15px] pb-[15px] shadow-[0_8px_0_rgba(103,103,103,0.05)] hovEffects transition-[transform_opacity] duration-[1s] after:bg-yellow">
