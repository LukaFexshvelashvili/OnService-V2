...
function AboutUs() {
  return (
    <section className="py-28 mediumS:pb-12 ">
        ...
        <div className="w-full px-10 py-10 rounded-infoCard bg-[rgba(255,255,255,0.85)] backdrop-blur-[10px] shadow-offerCard">
          <div className="flex mediumS:flex-col gap-10">
            <div className="flex gap-10 flex-col flex-1">
              <h3 className="text-main text-[24px] mediumS:text-[20px] mediumS:text-center tracking-wider">
                ჩვენს შესახებ
              </h3>
              <div className="flex flex-col gap-7 ">
                <div className="flex gap-3">
                  <div className="h-2 aspect-square rounded-[50%] translate-y-[10px] bg-main"></div>
                  <p className="text-text text-[18px] mediumS:text-[16px] mediumS:tracking-wide tracking-wider">
